...
data=as.data.table(readxl::read_excel("data/landuse_data/HYDRA_env_fluvialnetwork_input.xlsx",  sheet = "Climate"))
...
data=as.data.table(readxl::read_excel("data/landuse_data/HYDRA_env_fluvialnetwork_input.xlsx",  sheet = "Landuse"))
...
data=as.data.table(readxl::read_excel("data/landuse_data/HYDRA_env_fluvialnetwork_input.xlsx",  sheet = "Geo"))
