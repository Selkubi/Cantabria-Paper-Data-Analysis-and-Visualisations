...
#### Taking the data####
sample_loadings <- read_csv("data/PARAFAC_data/denormalised_sample_loadings.csv")
sample_names <- read_csv("data/metafiles/sample_name_site_match.csv")
site_info <- read_csv("data/metafiles/site_summary.csv")
meta_sum_optical <- read_csv("data/metafiles/meta_file.csv")
